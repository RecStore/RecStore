...
EXT_SOURCES = [
    ...
    # petps_client.cc: compiled directly because the pre-built libpet_kv.a
    # in build/lib/ is stale (missing SubmitUpdateParameterFlatGather added
    # by recent cleanup commits on master).
...
# wheel is self-contained without LD_LIBRARY_PATH).
# ---------------------------------------------------------------------------
